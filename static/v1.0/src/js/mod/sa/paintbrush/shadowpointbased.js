...
;define(function (require, exports, module){
    ...
    var _ShadowPointBased = function(canvas){
        ...
        brush.setShadowBlur(10);
        brush.setShadowColor("#000");
        brush.set("start", {
            callback : function(e, brush){
                ...
                if(false === this.setted){
                    ...
                    ctx.lineWidth = brush.lineWidth || 1;
    ...
    var _pub = {
        createPaintBrush : function(canvas){
            var ins = new _ShadowPointBased(canvas);
