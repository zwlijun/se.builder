...
;define(function LivePlayer(require, exports, module){
    ...
    var HTML_TEMPLATE = ''
                      ...
                      + '    <video src="<%=liveplayer.master.source%>"<%=liveplayer.master.loop ? " loop" : ""%><%=liveplayer.master.preload ? " preload" : ""%><%=liveplayer.master.autoplay ? " autoplay" : ""%> poster="<%=liveplayer.master.poster%>" x-webkit-airplay="true" webkit-playsinline="true" playsinline="true" x5-video-player-type="h5"></video>'
                      ...
                      + '    <video src="<%=liveplayer.pip.source%>" autoplay preload="auto" x-webkit-airplay="true" webkit-playsinline="true" playsinline="true" x5-video-player-type="h5"></video>'
