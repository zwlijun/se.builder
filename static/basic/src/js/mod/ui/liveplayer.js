...
;define(function LivePlayer(require, exports, module){
    ...
    var HTML_TEMPLATE = ''
                      ...
                      + '    <video src="<%=liveplayer.master.source%>"<%=liveplayer.master.loop ? " loop" : ""%><%=liveplayer.master.preload ? " preload" : ""%><%=liveplayer.master.autoplay ? " autoplay" : ""%> poster="<%=liveplayer.master.poster%>" webkit-playsinline playsinline></video>'
                      ...
                      + '    <video src="<%=liveplayer.pip.source%>" autoplay preload="auto" webkit-playsinline playsinline></video>'
